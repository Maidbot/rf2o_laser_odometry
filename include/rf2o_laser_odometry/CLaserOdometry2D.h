...
#include <maidbot_spatial_data/OccupancyData.h>
...
protected:
    ...
    void occHistCb(const maidbot_spatial_data::OccupancyData::ConstPtr& msg);
    void setOdomCovariances(nav_msgs::Odometry& odom, bool missingData=false);
    maidbot_spatial_data::OccupancyData occ_hist_;
